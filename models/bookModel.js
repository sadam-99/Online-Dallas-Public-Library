...
// TODO:
//  for book Boorrowing(Issuing)
var getUserBorrow = (customer_id, books, callback) => {
    var date = new Date();
    console.log(date);
    var sql = "INSERT INTO issue_date VALUES(null,?, ?, ?, ? )";
    // var due_date  = "SELECT DATE_ADD(CURDATE(), INTERVAL 7 DAY);
    // SELECT DATE_ADD(CURDATE(), INTERVAL 7 DAY)
    // var date_query = "cuekksnbv";
    db.executeQuery(sql, [books.book_id, books.user_id, date, date + 7 ], function(result) {
        callback(result);
    });
};

// TODO: Return Books (To be Uncommented after Borrow booking working)
// var borrower_return = (customer_id, book, callback) => {
//     var date = new Date();
//     var sql = "INSERT INTO  fines VALUES(?, ?, ? )";
//     db.executeQuery(sql, [customer_id,date, 5 ], function(result) {
//         callback(result);
//     });
// };
...
// TODO: Fine Payment
var sql = "select b.book_id,b.title, b.author from library_management_system.books b, library_management_system.issue_date i, library_management_system.fine f where f.issue_id = i.issue_id and i.book_id = b.book_id and f.fine > 00";

//  for book searching (browsing)
